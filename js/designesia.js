...
(function($) {
    ...
    function de_share(){
        ...
        $('.fa-twitter').on("click", function() { window.open('https://twitter.com'+url,'_blank'); });
        $('.fa-facebook').on("click", function() { window.open('https://www.facebook.com'+url,'_blank'); });
        $('.fa-reddit').on("click", function() { window.open('http://www.reddit.com'+url,'_blank'); });
        $('.fa-linkedin').on("click", function() { window.open('https://www.linkedin.com'+url,'_blank'); });
        $('.fa-pinterest').on("click", function() { window.open('https://www.pinterest.com'+url,'_blank'); });
        $('.fa-stumbleupon').on("click", function() { window.open('http://www.stumbleupon.com'+url,'_blank'); });
        $('.fa-delicious').on("click", function() { window.open('https://delicious.com'+url,'_blank'); });
        $('.fa-envelope').on("click", function() { window.open(''+url,'_blank'); });
